...
const init = async () => {
  ...
  web3.eth.subscribe('newBlockHeaders')
    ...
    if (profit1 > 0) {
        ...
        console.log('No Arb opportunity at this time.');
        console.log(`Profit 1 (buy in uniswap, sell in kyber): ${profit1}`);
        console.log(`Profit 2 (buy in kyber, sell in uniswap): ${profit2}`);
    }
